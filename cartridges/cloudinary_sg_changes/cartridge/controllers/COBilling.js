...
function returnToForm(cart, params) {
    ...
    if (params) {
        app.getView(require('*/cartridge/scripts/object').extend(params, { // Custom : Changed ~ to *
            Basket: cart.object,
...
function redeemGiftCertificateJson() {
    ...
    let responseUtils = require('*/cartridge/scripts/util/Response'); // Custom : Changed ~ to *
...
function getGiftCertificateBalance() {
    ...
    var responseUtils = require('*/cartridge/scripts/util/Response'); // Custom : Changed ~ to *
