...
const ProductUtils = require('*/cartridge/scripts/product/ProductUtils.js'); // Custom : Changed ~ to *
const ProductMgr = require('dw/catalog/ProductMgr');
const URLUtils = require('dw/web/URLUtils');
const Resource = require('dw/web/Resource');
// Custom Start: Cloudinary script modules //
var cloudinaryConstants = require('*/cartridge/scripts/util/cloudinaryConstants');
var cloudinaryModel = require('*/cartridge/scripts/model/cloudinaryModel');
// Custom End: Cloudinary script modules //
...
function _setAttrValuesWithSwatch (params) {
    ...
    // Custom End: Add cloudinary swatch image //
