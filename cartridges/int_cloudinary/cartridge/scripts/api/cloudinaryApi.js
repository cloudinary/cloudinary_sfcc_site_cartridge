                    ...
                    for (var idxAssets = 0; idxAssets < imgAssets.length; idxAssets++) {
                        ...
                        if (!empty(asset.metadata)) {
                            if (asset.metadata.length) {
                                ...
                                altText = asset.metadata[cloudinaryConstants.CLD_SMD_ALT_TEXT_KEY];
                            }
                        }
    ...
    try {
        if (cloudinaryConstants.CLD_ENABLED) {
            if (!empty(relativeURL)) {
                ...
                videoPoster = cloudinaryHelper.getVideoPoster(finalURL.finalURL);
