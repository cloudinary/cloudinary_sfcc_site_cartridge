...
exports.getModel = function (modelName) {
    return require('*/cartridge/scripts/models/' + modelName + 'Model'); // Custom: Changed ~ to *
};
...
exports.getView = function (viewName, parameters) {
    ...
    try {
        ...
        if (typeof viewName === 'string') {
            View = require('*/cartridge/scripts/views/' + viewName + 'View'); // Custom: Changed ~ to *
        } else {
            // use first argument as parameters if not a string
            // to allow for anonymous views
            parameters = viewName;
            View = require('*/cartridge/scripts/views/View'); // Custom: Changed ~ to *
        }
    } catch (e) {
        View = require('*/cartridge/scripts/views/View'); // Custom: Changed ~ to *
    }
...
exports.getForm = function (formReference) {
    ...
    FormModel = require('*/cartridge/scripts/models/FormModel'); // Custom: Changed ~ to *
    formInstance = null;
    if (typeof formReference === 'string') {
        formInstance = require('*/cartridge/scripts/object').resolve(session.forms, formReference); // Custom: Changed ~ to *
...
exports.getController = function (controllerName) {
    return require('*/cartridge/controllers/' + controllerName); // Custom: Changed ~ to *
};
