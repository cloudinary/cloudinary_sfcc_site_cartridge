...
CloudinaryConstants.CLD_GET_PRODUCT_IMG_URL_BY_POSITION_ERROR = 'Error occured while building product image url by Position using tag name, product ID: {0}, error : {1}';
