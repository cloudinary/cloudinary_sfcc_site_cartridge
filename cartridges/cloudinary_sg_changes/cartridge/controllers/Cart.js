...
// Custom Start: Cloudinary script module //
var cloudinaryConstants = require('*/cartridge/scripts/util/cloudinaryConstants');
// Custom End: Cloudinary script module //
...
function continueShopping() {
    ...
    var location = require('*/cartridge/scripts/util/Browsing').lastCatalogURL(); // Custom : Changed ~ to *
...
function addBonusProductJson() {
    ...
    for (i = 0; i < productsJSON.length; i += 1) {
        ...
        if (lineItem && product) {
            ...
            let r = require('*/cartridge/scripts/util/Response'); // Custom: Changed ~ to *
            r.renderJSON({
                success: false
            });
            return;
